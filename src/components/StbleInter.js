    ...
    return (
      <div className="parent">
        <div className="card p-4">
          <div className="title">
            Вам для этого потребуются: стабильный интернет, компьютер или
            ноутбук, наушники, личное пространство где вы сможете работать без
            посторонних шумов - вы располагаете всем необходимым?
          </div>
