    ...
    return (
      <div className="parent">
        <div className="card p-4">
          <div className="title">
            Мы предлагаем следующие условия: фиксированный оклад в размере 200$
            в месяц за полный рабочий день и выполнение минимальной ежедневной
            нормы звонков в размере 150 минут в линии. Премия оставляет от 20 до
            150% от оклада, в зависимости от ваших показателей. Средняя зарплата
